...
WELCOME_TEXT = (
    "🌿 Добро пожаловать.\n\n"
        ...
        "замечать новые смыслы и лучше слышать себя.\n\n"
        "Иногда образ или фраза открывают новую мысль, иногда просто помогают сделать паузу и услышать себя.\n"
        "А иногда — просто стать маленькой точкой опоры на день.\n\n"
        ...
        "Светлана Муратова, психолог @muratovablog.\n\n"
