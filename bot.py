...
async def cmd_start(message: Message):
    ...
    await message.answer(
        ...
        "Метафорическая карта — это образ и вопрос, которые помогают помогают в понимании своего состояния.\n\n"
        ...
        "Нажми «🌿 Карта дня» или «🌿 Выбрать карту» и посмотри, что откликнется сегодня.",
        reply_markup=main_menu_kb()
    )
